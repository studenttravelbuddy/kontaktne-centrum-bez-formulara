...
4.  zaplatíte poplatok 3,69 € cez Ubian alebo SMS,
5.  priložíte preukaz k UNIterminálu — až tým sa zľava aktivuje.
...
Vetvy
[OD 1. 9. 2026] Klient sa pýta na Orange/prechod na O2. Spolupráca s Orangeom sa skončila 31. 8. 2026 o 23:59, CKM od 1. 9. 2026 spolupracuje s O2. Existujúce paušály Orange/Yoxo
...
5. Starý bankový účet — je zrušený? (727 prípadov) — doriešené
...
6. Kedy sa nahráva nové číslo karty do aplikácie (546 prípadov) — doriešené
...
7. Kto spravuje dopravnú a čipovú časť (118 prípadov) — doriešené
...
8. Lehota vrátenia platby (87 prípadov) — doriešené
...
9. Zľava v Lidli — kedy zmizne z aplikácie a z webov (36 prípadov) — doriešené
   Spolupráca skončila 31. 7. a v databáze zliav Lidl naozaj nie je (overené
10. 8. 2026 — 190 partnerov, Lidl medzi nimi nefiguruje). Aplikácia ju však stále
...
11. Aplikácia my EYC — fotka, prihlásenie, reset hesla (22 prípadov) — doriešené
...
12. Má sa najprv overiť evidencia zo školy? (6 prípadov) — doriešené
...
13. Faktúra na zamestnávateľa (6 prípadov) — doriešené
...
14. Cena pri prechode zo ZŠ na SŠ (5 prípadov) — doriešené
...
15. Cena SMS na predĺženie dopravy (4 prípady) — doriešené
...
16. Dá sa zrušiť uhradená objednávka? (3 prípady) — doriešené
...
17. Preukaz vydaný školou bez fotky (2 prípady) — doriešené, CKM potvrdilo 27. 8. 2026
...
18. Zľava cez SheerID (Spotify a podobné) (1 prípad) — doriešené
...
19. Platí nečipový a mobilný ISIC na jednorazové zľavnené cestovné? — doriešené
...
20. Rozmer fotografie na preukaz ITIC klasik — doriešené
...
21. Prenesie sa nové číslo preukazu do Orangeu samo? — doriešené
...
22. Veková hranica pre Yoxo paušál — doriešené
...
23. Platí karta EURO<26 po zmene priezviska? — doriešené
...
3. **`isic.sk/isic-demo-aplikacia/` stále obsahuje starú, už neplatnú vetu** o preukaze ISIC v
   mobile: _"je akceptovaný na ISIC zľavy, ale nie na štátom poskytované zľavy vo verejnej
   doprave"_. Od 1. 7. 2026 to neplatí — platný ISIC v akejkoľvek forme (aj nečipový, aj v mobile)
...
_Overené priamym načítaním webov 29. 8. 2026. Ak sa niektorá zo stránok medzičasom opraví, táto
sekcia sa dá skrátiť/vymazať — hlavný obsah dátovej banky (články vyššie) zostáva zdrojom pravdy._
