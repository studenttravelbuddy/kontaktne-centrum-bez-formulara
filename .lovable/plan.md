...
| KniHart                                | `https://www.knihart.sk`                 | domény nefunguje | odkaz odstrániť (karta zostane bez odkazu) |
| Galéria kvetín                         | `http://www.galeriakvetin.sk`            | zlý certifikát | odkaz odstrániť                              |
| Expresná preprava (2×)                 | `http://www.expresnapreprava.sk`         | neodpovedá  | odkaz odstrániť                                 |
| Wakelake                               | `http://www.wakelake.sk`                 | 500         | odkaz odstrániť                                 |
