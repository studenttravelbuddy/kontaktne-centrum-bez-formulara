...
1. Nový komponent `src/components/site/RenewSection.tsx`
   ...
   - Karty/taby podľa typu preukazu a spôsobu vydania:
     - ISIC/ITIC vydaný školou (čipový) – predlžuje sa prolongačnou známkou (13 €), nie novým preukazom. Známka ISIC/EURO<26: `https://objednaj-preukaz.sk/produkt/znamka-isiceuro/`, známka ITIC (vlastná sezóna, platnosť do 12/2027): `https://objednaj-preukaz.sk/produkt/znamka-itic/`. Elektronické predĺženie platí ihneď po zakúpení, fyzická známka sa distribuuje koncom augusta / začiatkom septembra. Pri predĺžení počas kupónovej kampane klient dostane aj kupónovú knižku — fyzicky alebo elektronicky. Zľavu v doprave má držiteľ ISIC podľa zákona; známkou sa nepredlžuje doprava, ale funkcia čipu — tá sa rieši samostatne cez `https://www.ubian.sk/preukaz-studenta`. Na preukaz žiaka s vizuálom Ubian (bez loga ISIC) sa známka kúpiť nedá — v takom prípade odporúčame dokúpiť ISIC klasik: `https://objednaj-preukaz.sk/produkt/isic-klasik/`.
